          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
            ...
            {[
              ...
              <div key={i} className="group cursor-pointer">
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg overflow-hidden mb-4 sm:mb-6 group-hover:scale-105 transition-transform duration-300 relative">
                  <div className="w-full h-full flex items-center justify-center text-gray-500">
                    <div className="text-center">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-3 sm:mb-4 bg-gray-700 rounded-2xl flex items-center justify-center">
                  ...
                  <div className="absolute top-3 sm:top-4 right-3 sm:right-4 bg-white/10 backdrop-blur-sm px-2 sm:px-3 py-1 rounded-full text-xs font-medium">
                    Case Study
                  </div>
                </div>
                <div className="space-y-1 sm:space-y-2">
                  <span className="text-xs sm:text-sm text-gray-400 uppercase tracking-wider">{project.type}</span>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm text-gray-400">Design Awards</div>
            </div>
          </div>
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
            {[
              ...
              <span key={skill} className="px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 rounded-full text-xs sm:text-sm font-medium">
                {skill}
              </span>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Strategy & Research</h3>
              <p className="text-gray-400 text-xs sm:text-sm">User research, competitive analysis, and strategic planning</p>
            </div>
            <div className="text-center">
